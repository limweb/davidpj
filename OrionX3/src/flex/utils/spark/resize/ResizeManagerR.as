package flex.utils.spark.resize {
	 ...
	 */
	public class ResizeManagerR extends EventDispatcher {
		...
		private var overWidth:Number;


		public function ResizeManagerR(resizeComponent:UIComponent = null, resizeHandle:UIComponent = null, resizeDirection:String = "both") {
			this._enabled = true;
		...
		private function resizeMouseMoveHandler(event:MouseEvent):void {
			...
			if ((newWidth >= resizeComponent.minWidth) && (newWidth <= resizeComponent.maxWidth) && resizeH && getAllwidth() ) {
				...
				resizeComponent.width = newWidth - overWidth;
			}
